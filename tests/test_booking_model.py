...
def test_booking_from_row():
    row = {
        "bookingId": 1, "bookingRef": "REF1", "listingId": 10, "staffId": 100,
        "bookingDate": "2026-05-10", "numTickets": 2, "totalCost": 25.0, "status": BookingStatus.CONFIRMED
    }
...
def test_booking_create(mock_db):
    ...
    booking = Booking.create(listing_id=10, staff_id=100, num_tickets=2, total_cost=25.0)
