...
class ManagerController:
    ...
    def add_screen(self, cinema_id: int, screen_number: int,
                   total_capacity: int, lower_seats: int,
                   upper_seats: int) -> dict:
        ...
        return {"screenId": screen_id, "cinemaId": cinema_id,
    ...
    def get_all_cities(self) -> list:
        rows = db.fetchall(
            "SELECT DISTINCT city FROM pricing_rules ORDER BY city"
        )
    ...
    def update_pricing(self, city: str, show_type: str,
